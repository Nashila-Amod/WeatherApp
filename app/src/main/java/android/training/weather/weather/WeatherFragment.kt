package android.training.weather.weather

import android.os.Bundle
import android.training.weather.App
import android.training.weather.R
import android.training.weather.openweathermap.WeatherWrapper
import android.training.weather.openweathermap.mapOpenWeatherDataToWeather
...
class WeatherFragment : Fragment() {
    ...
    fun clearUi() {
        weatherIcon.setImageResource(R.drawable.cloud_off)
        cityName = ""
        city.text = ""
